// Error definitions for css variables
// BTC Proof-of-Action Receipt System

/**
 * Base error class for css variables module
 */
 ...
 */
export class ValidationError extends cssvariablesError {
 ...
 * Not found error
 */
export class NotFoundError extends cssvariablesError {
 ...
 * Timeout error
 */
export class TimeoutError extends cssvariablesError {
