// Error definitions for security policy
// BTC Proof-of-Action Receipt System

/**
 * Base error class for security policy module
 */
 ...
 */
export class ValidationError extends securitypolicyError {
 ...
 * Not found error
 */
export class NotFoundError extends securitypolicyError {
 ...
 * Timeout error
 */
export class TimeoutError extends securitypolicyError {
