// Error definitions for receipt lifecycle
// BTC Proof-of-Action Receipt System

/**
 * Base error class for receipt lifecycle module
 */
 ...
 */
export class ValidationError extends receiptlifecycleError {
 ...
 * Not found error
 */
export class NotFoundError extends receiptlifecycleError {
 ...
 * Timeout error
 */
export class TimeoutError extends receiptlifecycleError {
