// Error definitions for wallet reconnect
// BTC Proof-of-Action Receipt System

/**
 * Base error class for wallet reconnect module
 */
 ...
 */
export class ValidationError extends walletreconnectError {
 ...
 * Not found error
 */
export class NotFoundError extends walletreconnectError {
 ...
 * Timeout error
 */
export class TimeoutError extends walletreconnectError {
