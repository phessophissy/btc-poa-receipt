// Error definitions for input sanitization
// BTC Proof-of-Action Receipt System

/**
 * Base error class for input sanitization module
 */
 ...
 */
export class ValidationError extends inputsanitizationError {
 ...
 * Not found error
 */
export class NotFoundError extends inputsanitizationError {
 ...
 * Timeout error
 */
export class TimeoutError extends inputsanitizationError {
