// Error definitions for rate limiting
// BTC Proof-of-Action Receipt System

/**
 * Base error class for rate limiting module
 */
 ...
 */
export class ValidationError extends ratelimitingError {
 ...
 * Not found error
 */
export class NotFoundError extends ratelimitingError {
 ...
 * Timeout error
 */
export class TimeoutError extends ratelimitingError {
