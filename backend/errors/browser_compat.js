// Error definitions for browser compat
// BTC Proof-of-Action Receipt System

/**
 * Base error class for browser compat module
 */
 ...
 */
export class ValidationError extends browsercompatError {
 ...
 * Not found error
 */
export class NotFoundError extends browsercompatError {
 ...
 * Timeout error
 */
export class TimeoutError extends browsercompatError {
