// Error definitions for config loading
// BTC Proof-of-Action Receipt System

/**
 * Base error class for config loading module
 */
 ...
 */
export class ValidationError extends configloadingError {
 ...
 * Not found error
 */
export class NotFoundError extends configloadingError {
 ...
 * Timeout error
 */
export class TimeoutError extends configloadingError {
