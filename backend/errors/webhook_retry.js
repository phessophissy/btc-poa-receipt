// Error definitions for webhook retry
// BTC Proof-of-Action Receipt System

/**
 * Base error class for webhook retry module
 */
 ...
 */
export class ValidationError extends webhookretryError {
 ...
 * Not found error
 */
export class NotFoundError extends webhookretryError {
 ...
 * Timeout error
 */
export class TimeoutError extends webhookretryError {
