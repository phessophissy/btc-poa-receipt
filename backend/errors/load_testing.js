// Error definitions for load testing
// BTC Proof-of-Action Receipt System

/**
 * Base error class for load testing module
 */
 ...
 */
export class ValidationError extends loadtestingError {
 ...
 * Not found error
 */
export class NotFoundError extends loadtestingError {
 ...
 * Timeout error
 */
export class TimeoutError extends loadtestingError {
