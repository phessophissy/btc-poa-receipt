// Error definitions for webhook handler
// BTC Proof-of-Action Receipt System

/**
 * Base error class for webhook handler module
 */
 ...
 */
export class ValidationError extends webhookhandlerError {
 ...
 * Not found error
 */
export class NotFoundError extends webhookhandlerError {
 ...
 * Timeout error
 */
export class TimeoutError extends webhookhandlerError {
