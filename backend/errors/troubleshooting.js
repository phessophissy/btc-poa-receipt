// Error definitions for troubleshooting
// BTC Proof-of-Action Receipt System

/**
 * Base error class for troubleshooting module
 */
 ...
 */
export class ValidationError extends troubleshootingError {
 ...
 * Not found error
 */
export class NotFoundError extends troubleshootingError {
 ...
 * Timeout error
 */
export class TimeoutError extends troubleshootingError {
