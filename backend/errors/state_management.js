// Error definitions for state management
// BTC Proof-of-Action Receipt System

/**
 * Base error class for state management module
 */
 ...
 */
export class ValidationError extends statemanagementError {
 ...
 * Not found error
 */
export class NotFoundError extends statemanagementError {
 ...
 * Timeout error
 */
export class TimeoutError extends statemanagementError {
