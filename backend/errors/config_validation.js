// Error definitions for config validation
// BTC Proof-of-Action Receipt System

/**
 * Base error class for config validation module
 */
 ...
 * Not found error
 */
export class NotFoundError extends configvalidationError {
 ...
 * Timeout error
 */
export class TimeoutError extends configvalidationError {
