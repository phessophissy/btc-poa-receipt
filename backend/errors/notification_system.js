...
/**
 * Base error class for notification system module
 */
 ...
 */
export class ValidationError extends notificationsystemError {
 ...
 * Not found error
 */
export class NotFoundError extends notificationsystemError {
 ...
 * Timeout error
 */
export class TimeoutError extends notificationsystemError {
