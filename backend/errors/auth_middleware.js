// Error definitions for auth middleware
// BTC Proof-of-Action Receipt System

/**
 * Base error class for auth middleware module
 */
 ...
 */
export class ValidationError extends authmiddlewareError {
 ...
 * Not found error
 */
export class NotFoundError extends authmiddlewareError {
 ...
 * Timeout error
 */
export class TimeoutError extends authmiddlewareError {
