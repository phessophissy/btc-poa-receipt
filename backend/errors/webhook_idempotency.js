// Error definitions for webhook idempotency
// BTC Proof-of-Action Receipt System

/**
 * Base error class for webhook idempotency module
 */
 ...
 */
export class ValidationError extends webhookidempotencyError {
 ...
 * Not found error
 */
export class NotFoundError extends webhookidempotencyError {
 ...
 * Timeout error
 */
export class TimeoutError extends webhookidempotencyError {
