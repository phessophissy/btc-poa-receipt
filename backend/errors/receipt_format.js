// Error definitions for receipt format
// BTC Proof-of-Action Receipt System

/**
 * Base error class for receipt format module
 */
 ...
 */
export class ValidationError extends receiptformatError {
 ...
 * Not found error
 */
export class NotFoundError extends receiptformatError {
 ...
 * Timeout error
 */
export class TimeoutError extends receiptformatError {
