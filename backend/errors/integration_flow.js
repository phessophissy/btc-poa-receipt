// Error definitions for integration flow
// BTC Proof-of-Action Receipt System

/**
 * Base error class for integration flow module
 */
 ...
 */
export class ValidationError extends integrationflowError {
 ...
 * Not found error
 */
export class NotFoundError extends integrationflowError {
 ...
 * Timeout error
 */
export class TimeoutError extends integrationflowError {
