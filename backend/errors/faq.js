// Error definitions for faq
// BTC Proof-of-Action Receipt System

/**
 * Base error class for faq module
 */
 ...
 */
export class ValidationError extends faqError {
 ...
 * Not found error
 */
export class NotFoundError extends faqError {
 ...
 * Timeout error
 */
export class TimeoutError extends faqError {
