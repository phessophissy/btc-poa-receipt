// Error definitions for receipt builder
// BTC Proof-of-Action Receipt System

/**
 * Base error class for receipt builder module
 */
 ...
 */
export class ValidationError extends receiptbuilderError {
 ...
 * Not found error
 */
export class NotFoundError extends receiptbuilderError {
 ...
 * Timeout error
 */
export class TimeoutError extends receiptbuilderError {
