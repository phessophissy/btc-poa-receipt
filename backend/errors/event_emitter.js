// Error definitions for event emitter
// BTC Proof-of-Action Receipt System

/**
 * Base error class for event emitter module
 */
 ...
 */
export class ValidationError extends eventemitterError {
 ...
 * Not found error
 */
export class NotFoundError extends eventemitterError {
 ...
 * Timeout error
 */
export class TimeoutError extends eventemitterError {
