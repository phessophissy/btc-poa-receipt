// Error definitions for validation layer
// BTC Proof-of-Action Receipt System

/**
 * Base error class for validation layer module
 */
 ...
 */
export class ValidationError extends validationlayerError {
 ...
 * Not found error
 */
export class NotFoundError extends validationlayerError {
 ...
 * Timeout error
 */
export class TimeoutError extends validationlayerError {
