// Error definitions for bulk operations
// BTC Proof-of-Action Receipt System

/**
 * Base error class for bulk operations module
 */
 ...
 */
export class ValidationError extends bulkoperationsError {
 ...
 * Not found error
 */
export class NotFoundError extends bulkoperationsError {
 ...
 * Timeout error
 */
export class TimeoutError extends bulkoperationsError {
