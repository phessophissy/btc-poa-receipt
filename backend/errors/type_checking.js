// Error definitions for type checking
// BTC Proof-of-Action Receipt System

/**
 * Base error class for type checking module
 */
 ...
 */
export class ValidationError extends typecheckingError {
 ...
 * Not found error
 */
export class NotFoundError extends typecheckingError {
 ...
 * Timeout error
 */
export class TimeoutError extends typecheckingError {
