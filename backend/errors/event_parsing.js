// Error definitions for event parsing
// BTC Proof-of-Action Receipt System

/**
 * Base error class for event parsing module
 */
 ...
 */
export class ValidationError extends eventparsingError {
 ...
 * Not found error
 */
export class NotFoundError extends eventparsingError {
 ...
 * Timeout error
 */
export class TimeoutError extends eventparsingError {
