// Error definitions for analytics endpoint
// BTC Proof-of-Action Receipt System

/**
 * Base error class for analytics endpoint module
 */
 ...
 */
export class ValidationError extends analyticsendpointError {
 ...
 * Not found error
 */
export class NotFoundError extends analyticsendpointError {
 ...
 * Timeout error
 */
export class TimeoutError extends analyticsendpointError {
