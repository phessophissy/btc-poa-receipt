// Error definitions for concurrent writes
// BTC Proof-of-Action Receipt System

/**
 * Base error class for concurrent writes module
 */
 ...
 */
export class ValidationError extends concurrentwritesError {
 ...
 * Not found error
 */
export class NotFoundError extends concurrentwritesError {
 ...
 * Timeout error
 */
export class TimeoutError extends concurrentwritesError {
