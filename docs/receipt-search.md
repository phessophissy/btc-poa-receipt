...
This document describes the receipt search implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt search to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt search will touch the following components:
