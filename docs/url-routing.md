# improve URL routing structure

## Overview

This document describes the url routing implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs url routing to improve reliability and user experience.
...
### Proposed Changes
Changes related to url routing will touch the following components:
