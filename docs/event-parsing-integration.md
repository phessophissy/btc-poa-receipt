# event parsing - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /event-parsing
...
### Rollback Plan
If issues arise, disable via `event-parsing_ENABLED=false` environment variable.
