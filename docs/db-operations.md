...
This document describes the db operations implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs db operations to improve reliability and user experience.
...
### Proposed Changes
Changes related to db operations will touch the following components:
