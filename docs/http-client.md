...
This document describes the http client implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs http client to improve reliability and user experience.
...
### Proposed Changes
Changes related to http client will touch the following components:
