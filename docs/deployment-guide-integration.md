# deployment guide - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /deployment-guide
...
### Rollback Plan
If issues arise, disable via `deployment-guide_ENABLED=false` environment variable.
