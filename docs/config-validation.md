...
This document describes the config validation implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs config validation to improve reliability and user experience.
...
### Proposed Changes
Changes related to config validation will touch the following components:
