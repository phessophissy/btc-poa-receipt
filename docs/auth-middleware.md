...
This document describes the auth middleware implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs auth middleware to improve reliability and user experience.
...
### Proposed Changes
Changes related to auth middleware will touch the following components:
