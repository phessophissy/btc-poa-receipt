# frontend modules - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /frontend-modules
...
### Rollback Plan
If issues arise, disable via `frontend-modules_ENABLED=false` environment variable.
