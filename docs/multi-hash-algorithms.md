...
This document describes the multi hash algorithms implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs multi hash algorithms to improve reliability and user experience.
...
### Proposed Changes
Changes related to multi hash algorithms will touch the following components:
