...
This document describes the event emitter implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs event emitter to improve reliability and user experience.
...
### Proposed Changes
Changes related to event emitter will touch the following components:
