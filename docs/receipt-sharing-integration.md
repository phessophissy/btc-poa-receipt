# receipt sharing - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-sharing
...
### Rollback Plan
If issues arise, disable via `receipt-sharing_ENABLED=false` environment variable.
