# receipt builder - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-builder
...
### Rollback Plan
If issues arise, disable via `receipt-builder_ENABLED=false` environment variable.
