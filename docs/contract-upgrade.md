# plan smart contract upgrade

## Overview

This document describes the contract upgrade implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs contract upgrade to improve reliability and user experience.
...
### Proposed Changes
Changes related to contract upgrade will touch the following components:
