...
This document describes the security policy implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs security policy to improve reliability and user experience.
...
### Proposed Changes
Changes related to security policy will touch the following components:
