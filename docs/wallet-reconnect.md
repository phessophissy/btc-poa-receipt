# handle wallet reconnection edge case

## Overview

This document describes the wallet reconnect implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs wallet reconnect to improve reliability and user experience.
...
### Proposed Changes
Changes related to wallet reconnect will touch the following components:
