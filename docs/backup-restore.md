...
This document describes the backup restore implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs backup restore to improve reliability and user experience.
...
### Proposed Changes
Changes related to backup restore will touch the following components:
