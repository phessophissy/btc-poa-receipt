...
This document describes the performance bench implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs performance bench to improve reliability and user experience.
...
### Proposed Changes
Changes related to performance bench will touch the following components:
