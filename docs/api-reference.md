...
This document describes the api reference implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs api reference to improve reliability and user experience.
...
### Proposed Changes
Changes related to api reference will touch the following components:
