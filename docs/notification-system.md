...
This document describes the notification system implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs notification system to improve reliability and user experience.
...
### Proposed Changes
Changes related to notification system will touch the following components:
