...
This document describes the session persistence implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs session persistence to improve reliability and user experience.
...
### Proposed Changes
Changes related to session persistence will touch the following components:
