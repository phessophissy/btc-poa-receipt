...
This document describes the receipt qr code implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt qr code to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt qr code will touch the following components:
