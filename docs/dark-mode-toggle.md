...
This document describes the dark mode toggle implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs dark mode toggle to improve reliability and user experience.
...
### Proposed Changes
Changes related to dark mode toggle will touch the following components:
