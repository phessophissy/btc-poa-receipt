# receipt ordering - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-ordering
...
### Rollback Plan
If issues arise, disable via `receipt-ordering_ENABLED=false` environment variable.
