# resolve CSS overflow issues

## Overview

This document describes the css overflow implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs css overflow to improve reliability and user experience.
...
### Proposed Changes
Changes related to css overflow will touch the following components:
