# clarity contract - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /clarity-contract
...
### Rollback Plan
If issues arise, disable via `clarity-contract_ENABLED=false` environment variable.
