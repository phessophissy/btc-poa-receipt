# resolve database race condition

## Overview

This document describes the db race condition implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs db race condition to improve reliability and user experience.
...
### Proposed Changes
Changes related to db race condition will touch the following components:
