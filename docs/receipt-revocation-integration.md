# receipt revocation - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-revocation
...
### Rollback Plan
If issues arise, disable via `receipt-revocation_ENABLED=false` environment variable.
