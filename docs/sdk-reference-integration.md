# sdk reference - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /sdk-reference
...
### Rollback Plan
If issues arise, disable via `sdk-reference_ENABLED=false` environment variable.
