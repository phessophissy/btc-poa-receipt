# add proof categorization

## Overview

This document describes the proof categories implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs proof categories to improve reliability and user experience.
...
### Proposed Changes
Changes related to proof categories will touch the following components:
