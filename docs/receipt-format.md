# document receipt data format

## Overview

This document describes the receipt format implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt format to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt format will touch the following components:
