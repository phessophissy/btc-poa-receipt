...
This document describes the rate limiting implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs rate limiting to improve reliability and user experience.
...
### Proposed Changes
Changes related to rate limiting will touch the following components:
