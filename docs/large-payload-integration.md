# large payload - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /large-payload
...
### Rollback Plan
If issues arise, disable via `large-payload_ENABLED=false` environment variable.
