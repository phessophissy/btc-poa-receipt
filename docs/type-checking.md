...
This document describes the type checking implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs type checking to improve reliability and user experience.
...
### Proposed Changes
Changes related to type checking will touch the following components:
