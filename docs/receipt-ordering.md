# correct receipt ordering logic

## Overview

This document describes the receipt ordering implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt ordering to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt ordering will touch the following components:
