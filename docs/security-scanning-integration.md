# security scanning - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /security-scanning
...
### Rollback Plan
If issues arise, disable via `security-scanning_ENABLED=false` environment variable.
