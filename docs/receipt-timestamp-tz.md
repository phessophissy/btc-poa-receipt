# correct receipt timestamp timezone

## Overview

This document describes the receipt timestamp tz implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt timestamp tz to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt timestamp tz will touch the following components:
