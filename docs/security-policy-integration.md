# security policy - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /security-policy
...
### Rollback Plan
If issues arise, disable via `security-policy_ENABLED=false` environment variable.
