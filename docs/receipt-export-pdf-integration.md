# receipt export pdf - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-export-pdf
...
### Rollback Plan
If issues arise, disable via `receipt-export-pdf_ENABLED=false` environment variable.
