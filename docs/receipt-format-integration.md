# receipt format - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-format
...
### Rollback Plan
If issues arise, disable via `receipt-format_ENABLED=false` environment variable.
