# receipt formatter - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-formatter
...
### Rollback Plan
If issues arise, disable via `receipt-formatter_ENABLED=false` environment variable.
