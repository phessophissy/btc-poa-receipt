# api reference - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /api-reference
...
### Rollback Plan
If issues arise, disable via `api-reference_ENABLED=false` environment variable.
