# integration flow - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /integration-flow
...
### Rollback Plan
If issues arise, disable via `integration-flow_ENABLED=false` environment variable.
