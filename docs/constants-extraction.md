...
This document describes the constants extraction implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs constants extraction to improve reliability and user experience.
...
### Proposed Changes
Changes related to constants extraction will touch the following components:
