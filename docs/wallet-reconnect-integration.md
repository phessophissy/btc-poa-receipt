# wallet reconnect - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /wallet-reconnect
...
### Rollback Plan
If issues arise, disable via `wallet-reconnect_ENABLED=false` environment variable.
