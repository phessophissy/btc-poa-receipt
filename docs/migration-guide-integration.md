# migration guide - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /migration-guide
...
### Rollback Plan
If issues arise, disable via `migration-guide_ENABLED=false` environment variable.
