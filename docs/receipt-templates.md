...
This document describes the receipt templates implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt templates to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt templates will touch the following components:
