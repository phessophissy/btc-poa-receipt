# improve event parsing logic

## Overview

This document describes the event parsing implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs event parsing to improve reliability and user experience.
...
### Proposed Changes
Changes related to event parsing will touch the following components:
