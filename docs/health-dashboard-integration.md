# health dashboard - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /health-dashboard
...
### Rollback Plan
If issues arise, disable via `health-dashboard_ENABLED=false` environment variable.
