...
This document describes the config loading implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs config loading to improve reliability and user experience.
...
### Proposed Changes
Changes related to config loading will touch the following components:
