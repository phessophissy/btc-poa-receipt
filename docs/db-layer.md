...
This document describes the db layer implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs db layer to improve reliability and user experience.
...
### Proposed Changes
Changes related to db layer will touch the following components:
