# receipt qr code - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-qr-code
...
### Rollback Plan
If issues arise, disable via `receipt-qr-code_ENABLED=false` environment variable.
