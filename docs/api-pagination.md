...
This document describes the api pagination implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs api pagination to improve reliability and user experience.
...
### Proposed Changes
Changes related to api pagination will touch the following components:
