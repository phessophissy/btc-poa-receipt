...
This document describes the browser compat implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs browser compat to improve reliability and user experience.
...
### Proposed Changes
Changes related to browser compat will touch the following components:
