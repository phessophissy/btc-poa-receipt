# proof categories - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /proof-categories
...
### Rollback Plan
If issues arise, disable via `proof-categories_ENABLED=false` environment variable.
