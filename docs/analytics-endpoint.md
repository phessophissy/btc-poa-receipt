...
This document describes the analytics endpoint implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs analytics endpoint to improve reliability and user experience.
...
### Proposed Changes
Changes related to analytics endpoint will touch the following components:
