...
This document describes the user dashboard implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs user dashboard to improve reliability and user experience.
...
### Proposed Changes
Changes related to user dashboard will touch the following components:
