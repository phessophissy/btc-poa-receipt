...
This document describes the css variables implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs css variables to improve reliability and user experience.
...
### Proposed Changes
Changes related to css variables will touch the following components:
