# create SDK reference docs

## Overview

This document describes the sdk reference implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs sdk reference to improve reliability and user experience.
...
### Proposed Changes
Changes related to sdk reference will touch the following components:
