...
This document describes the monitoring implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs monitoring to improve reliability and user experience.
...
### Proposed Changes
Changes related to monitoring will touch the following components:
