...
This document describes the api versioning implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs api versioning to improve reliability and user experience.
...
### Proposed Changes
Changes related to api versioning will touch the following components:
