...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /bulk-verify
...
### Rollback Plan
If issues arise, disable via `bulk-verify_ENABLED=false` environment variable.
