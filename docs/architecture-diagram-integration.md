# architecture diagram - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /architecture-diagram
...
### Rollback Plan
If issues arise, disable via `architecture-diagram_ENABLED=false` environment variable.
