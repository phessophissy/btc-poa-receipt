...
This document describes the auth flow implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs auth flow to improve reliability and user experience.
...
### Proposed Changes
Changes related to auth flow will touch the following components:
