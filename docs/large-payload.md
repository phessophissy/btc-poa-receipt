...
This document describes the large payload implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs large payload to improve reliability and user experience.
...
### Proposed Changes
Changes related to large payload will touch the following components:
