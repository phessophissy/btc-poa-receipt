...
This document describes the data integrity implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs data integrity to improve reliability and user experience.
...
### Proposed Changes
Changes related to data integrity will touch the following components:
