...
This document describes the security scanning implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs security scanning to improve reliability and user experience.
...
### Proposed Changes
Changes related to security scanning will touch the following components:
