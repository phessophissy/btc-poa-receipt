...
This document describes the webhook handler implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs webhook handler to improve reliability and user experience.
...
### Proposed Changes
Changes related to webhook handler will touch the following components:
