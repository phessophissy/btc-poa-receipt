...
This document describes the receipt export pdf implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt export pdf to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt export pdf will touch the following components:
