# correct CORS header configuration

## Overview

This document describes the cors headers implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs cors headers to improve reliability and user experience.
...
### Proposed Changes
Changes related to cors headers will touch the following components:
