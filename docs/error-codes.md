...
This document describes the error codes implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs error codes to improve reliability and user experience.
...
### Proposed Changes
Changes related to error codes will touch the following components:
