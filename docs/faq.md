...
This document describes the faq implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs faq to improve reliability and user experience.
...
### Proposed Changes
Changes related to faq will touch the following components:
