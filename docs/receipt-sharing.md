...
This document describes the receipt sharing implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt sharing to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt sharing will touch the following components:
