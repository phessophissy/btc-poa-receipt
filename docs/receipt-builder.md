# create receipt builder pattern

## Overview

This document describes the receipt builder implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt builder to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt builder will touch the following components:
