# webhook integration - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /webhook-integration
...
### Rollback Plan
If issues arise, disable via `webhook-integration_ENABLED=false` environment variable.
