...
This document describes the compliance implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs compliance to improve reliability and user experience.
...
### Proposed Changes
Changes related to compliance will touch the following components:
