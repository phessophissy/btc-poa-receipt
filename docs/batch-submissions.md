# support batch proof submissions

## Overview

This document describes the batch submissions implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs batch submissions to improve reliability and user experience.
...
### Proposed Changes
Changes related to batch submissions will touch the following components:
