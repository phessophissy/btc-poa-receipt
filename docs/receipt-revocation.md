# add receipt revocation

## Overview

This document describes the receipt revocation implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt revocation to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt revocation will touch the following components:
