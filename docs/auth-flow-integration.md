...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /auth-flow
...
### Rollback Plan
If issues arise, disable via `auth-flow_ENABLED=false` environment variable.
