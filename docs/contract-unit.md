# add Clarity contract unit tests

## Overview

This document describes the contract unit implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs contract unit to improve reliability and user experience.
...
### Proposed Changes
Changes related to contract unit will touch the following components:
