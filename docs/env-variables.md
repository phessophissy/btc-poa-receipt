...
This document describes the env variables implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs env variables to improve reliability and user experience.
...
### Proposed Changes
Changes related to env variables will touch the following components:
