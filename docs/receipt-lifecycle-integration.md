# receipt lifecycle - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /receipt-lifecycle
...
### Rollback Plan
If issues arise, disable via `receipt-lifecycle_ENABLED=false` environment variable.
