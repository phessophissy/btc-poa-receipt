# fix memory leak in polling logic

## Overview

This document describes the memory leak polling implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs memory leak polling to improve reliability and user experience.
...
### Proposed Changes
Changes related to memory leak polling will touch the following components:
