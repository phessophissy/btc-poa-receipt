...
This document describes the bulk verify implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs bulk verify to improve reliability and user experience.
...
### Proposed Changes
Changes related to bulk verify will touch the following components:
