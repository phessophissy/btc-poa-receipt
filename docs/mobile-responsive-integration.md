# mobile responsive - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /mobile-responsive
...
### Rollback Plan
If issues arise, disable via `mobile-responsive_ENABLED=false` environment variable.
