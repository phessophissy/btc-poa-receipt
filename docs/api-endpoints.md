...
This document describes the api endpoints implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs api endpoints to improve reliability and user experience.
...
### Proposed Changes
Changes related to api endpoints will touch the following components:
