...
This document describes the mobile responsive implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs mobile responsive to improve reliability and user experience.
...
### Proposed Changes
Changes related to mobile responsive will touch the following components:
