# add Clarity contract documentation

## Overview

This document describes the clarity contract implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs clarity contract to improve reliability and user experience.
...
### Proposed Changes
Changes related to clarity contract will touch the following components:
