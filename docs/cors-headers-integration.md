# cors headers - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /cors-headers
...
### Rollback Plan
If issues arise, disable via `cors-headers_ENABLED=false` environment variable.
