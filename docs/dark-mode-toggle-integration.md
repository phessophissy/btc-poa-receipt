# dark mode toggle - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /dark-mode-toggle
...
### Rollback Plan
If issues arise, disable via `dark-mode-toggle_ENABLED=false` environment variable.
