# constants extraction - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /constants-extraction
...
### Rollback Plan
If issues arise, disable via `constants-extraction_ENABLED=false` environment variable.
