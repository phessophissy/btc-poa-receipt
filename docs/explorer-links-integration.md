# explorer links - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /explorer-links
...
### Rollback Plan
If issues arise, disable via `explorer-links_ENABLED=false` environment variable.
