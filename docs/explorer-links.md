# update explorer link format

## Overview

This document describes the explorer links implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs explorer links to improve reliability and user experience.
...
### Proposed Changes
Changes related to explorer links will touch the following components:
