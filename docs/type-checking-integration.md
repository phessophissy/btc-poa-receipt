# type checking - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /type-checking
...
### Rollback Plan
If issues arise, disable via `type-checking_ENABLED=false` environment variable.
