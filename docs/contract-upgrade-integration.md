# contract upgrade - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /contract-upgrade
...
### Rollback Plan
If issues arise, disable via `contract-upgrade_ENABLED=false` environment variable.
