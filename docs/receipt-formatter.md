# create receipt formatter utility

## Overview

This document describes the receipt formatter implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs receipt formatter to improve reliability and user experience.
...
### Proposed Changes
Changes related to receipt formatter will touch the following components:
