# api versioning - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /api-versioning
...
### Rollback Plan
If issues arise, disable via `api-versioning_ENABLED=false` environment variable.
