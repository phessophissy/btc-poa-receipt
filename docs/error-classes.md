...
This document describes the error classes implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs error classes to improve reliability and user experience.
...
### Proposed Changes
Changes related to error classes will touch the following components:
