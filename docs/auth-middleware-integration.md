# auth middleware - Integration Notes
...
### Integration Points
1. **Backend Server** (`server.js`): Add route handler for /auth-middleware
...
### Rollback Plan
If issues arise, disable via `auth-middleware_ENABLED=false` environment variable.
