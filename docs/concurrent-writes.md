...
This document describes the concurrent writes implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs concurrent writes to improve reliability and user experience.
...
### Proposed Changes
Changes related to concurrent writes will touch the following components:
