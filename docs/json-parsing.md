...
This document describes the json parsing implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs json parsing to improve reliability and user experience.
...
### Proposed Changes
Changes related to json parsing will touch the following components:
