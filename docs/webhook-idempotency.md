...
This document describes the webhook idempotency implementation for the Bitcoin Proof-of-Action Receipt System.

## Background

The BTC PoA Receipt system needs webhook idempotency to improve reliability and user experience.
...
### Proposed Changes
Changes related to webhook idempotency will touch the following components:
